...
namespace CarBook.WebUI.ViewComponents.DefaultViewComponents
{
    public class _DefaultStatisticsComponentPartial:ViewComponent
    {
        ...
        public async Task<IViewComponentResult>  InvokeAsync()
        {
            ...
            #region BrandCount
            var responseMessage3 = await client.GetAsync("https://localhost:7193/api/Statistics/GetBrandCount");
            ...
            var responseMessage4 = await client.GetAsync("https://localhost:7193/api/Statistics/GetCarCountByFuelElectric");
